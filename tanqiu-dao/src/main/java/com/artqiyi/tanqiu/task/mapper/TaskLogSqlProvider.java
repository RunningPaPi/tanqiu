...
import com.artqiyi.tanqiu.task.domain.TaskLogExample.Criterion;
...
public class TaskLogSqlProvider {
    ...
    public String insertSelective(TaskLog record) {
        ...
        if (record.getTaskState() != null) {
            VALUES("task_state", "#{taskState,jdbcType=SMALLINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getTaskLogId() != null) {
            SET("task_log_id = #{record.taskLogId,jdbcType=BIGINT}");
        }
        ...
        if (record.getTaskState() != null) {
            SET("task_state = #{record.taskState,jdbcType=SMALLINT}");
        }
    ...
    public String updateByPrimaryKeySelective(TaskLog record) {
        ...
        if (record.getTaskState() != null) {
            SET("task_state = #{taskState,jdbcType=SMALLINT}");
        }
    ...
    protected void applyWhere(TaskLogExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
